...
use App\DatabaseMigrations\AppMigration;

class UploadLongmanTelegramBot0551Tables extends AppMigration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `username` (`username`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `chat` (
  ...
  KEY `old_id` (`old_id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `user_chat` (
  ...
  FOREIGN KEY (`chat_id`) REFERENCES `chat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `inline_query` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `chosen_inline_result` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `message` (
  ...
  FOREIGN KEY (`left_chat_member`) REFERENCES `user` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `callback_query` (
  `id` bigint UNSIGNED COMMENT 'Unique identifier for this query',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
  ...
  FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `message` (`chat_id`, `id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `edited_message` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` bigint COMMENT 'Unique chat identifier',
  `message_id` bigint UNSIGNED COMMENT 'Unique message identifier',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
  ...
  FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `telegram_update` (
  ...
  FOREIGN KEY (`edited_message_id`) REFERENCES `edited_message` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `conversation` (
  ...
  FOREIGN KEY (`chat_id`) REFERENCES `chat` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `botan_shortener` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `user_id` bigint NULL DEFAULT NULL COMMENT 'Unique user identifier',
  ...
  FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
        ...
        $this->getPdo()->exec("CREATE TABLE IF NOT EXISTS `request_limiter` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  ...
  PRIMARY KEY (`id`)
    ...
    {
        $this->getDatabaseConnection()->dropIfExists('request_limiter');
        $this->getDatabaseConnection()->dropIfExists('botan_shortener');
        $this->getDatabaseConnection()->dropIfExists('conversation');
        $this->getDatabaseConnection()->dropIfExists('telegram_update');
        $this->getDatabaseConnection()->dropIfExists('edited_message');
        $this->getDatabaseConnection()->dropIfExists('callback_query');
        $this->getDatabaseConnection()->dropIfExists('message');
        $this->getDatabaseConnection()->dropIfExists('chosen_inline_result');
        $this->getDatabaseConnection()->dropIfExists('inline_query');
        $this->getDatabaseConnection()->dropIfExists('user_chat');
        $this->getDatabaseConnection()->dropIfExists('chat');
        $this->getDatabaseConnection()->dropIfExists('user');
    }
}
