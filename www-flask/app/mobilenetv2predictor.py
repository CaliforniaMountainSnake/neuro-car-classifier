...
class MobileNetV2Predictor(BasePredictor):
    ...
    @staticmethod
    def __get_labels():
        """Получить лейблы классов. Важно! При тренировке сети с использованием flow_from_directory() порядок классов
        отличается от лексикографического! Получить лейблы можно из DirectoryIterator.class_indices."""
        return ['AM General Hummer SUV 2000',
